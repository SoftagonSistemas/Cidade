...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/admin/instituicao/servicos/': RouteRecordInfo<'/admin/instituicao/servicos/', '/admin/instituicao/servicos', Record<never, never>, Record<never, never>>,
    ...
    '/admin/tickets/details/[id]': RouteRecordInfo<'/admin/tickets/details/[id]', '/admin/tickets/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
